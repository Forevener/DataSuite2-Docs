---
title: Планировщик анализа
description: Анализ мощности, конвертер размеров эффекта, поправка к уровню значимости, планирование надёжности, точности и распределения по группам в DataSuite 2.
---
...
И кривую мощности, и тепловую карту чувствительности можно изменять в размере, и у каждой есть собственные кнопки экспорта SVG / PNG / JPG рядом с графиком (см. [изменение размера и экспорт графиков](./getting-started.md#изменение-размера-и-экспорт-графиков)); отдельная кнопка **Экспортировать кривую в PNG** выше – это дополнительный быстрый способ сохранить кривую с двукратным разрешением.
