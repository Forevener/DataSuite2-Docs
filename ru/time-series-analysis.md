...
**Интерпретация пиков периодограммы на глаз как значимых.** Периодограмма — шумная оценка. Пик, «явно выше остальных», может быть выборочным артефактом, особенно на рядах короче нескольких сотен наблюдений. Сверьтесь с АКФ — если тот же период проявился и там, основание твёрже.
