---
title: Преобразование данных в DataSuite 2
description: Перекодирование значений, вычисление формул, замена по регулярным выражениям, стандартизация переменных, изменение структуры данных и управление правилами преобразований в DataSuite 2.
---
