...
Пока правило существует, переменные, которые оно читает или записывает, защищены на вкладке **Управление** диалога [Переменные](./getting-started.md#выбор-переменных) – там их можно переставлять, но нельзя переименовать или удалить. Сначала удалите правило.
