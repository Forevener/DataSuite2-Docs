---
title: Конфирматорный факторный анализ в DataSuite 2
description: Спецификация модели КФА, индексы подгонки, индексы модификации, проверка измерительной инвариантности, дискриминантная валидность и сравнение моделей в DataSuite 2.
---
