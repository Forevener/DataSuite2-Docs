---
title: Сравнительный анализ в DataSuite 2
description: Сравнение независимых, зависимых и смешанных выборок с помощью t-критерия, дисперсионного анализа, критерия Манна–Уитни, хи-квадрат, и других методов в DataSuite 2.
---
...
Для двухвыборочных критериев (t-критерии, Манна–Уитни, Уилкоксона):
...
Для многогрупповых критериев параметр скрыт.
...
Установите флажок **Включить визуализацию**, чтобы построить сгруппированные коробчатые графики, отображающие распределение по группам или условиям. Доступно только для числовых зависимых переменных.
...
При включённой опции отдельная карточка вывода «Сравнение распределений» показывает сгруппированные коробчатые графики для каждой числовой зависимой переменной — распределение по группам или условиям. В факторных дизайнах метка оси X содержит названия всех задействованных переменных.

Коробчатые графики строятся по тому же принципу, что и в [анализе распределения](./distribution-analysis.md#ящик-с-усами-коробчатый-график), с теми же параметрами изменения размера и экспорта (SVG, PNG, JPG).
